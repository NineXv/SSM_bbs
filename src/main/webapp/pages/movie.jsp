    ...
    <script>
        function addMovie() {
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/movie/addMovie" ,//url
                data: JSON.stringify({
                    name: mname,
                    country: country,
                    director: director,
        ...
        <div class="nano-content">
            <ul>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-target"></i> 管理 <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/pages/management.jsp">删除帖子</a></li>
                        <li><a href="${pageContext.request.contextPath}/pages/movie.jsp">添加电影</a></li>
                    </ul>
                </li>
            </ul>
        </div>
                                ...
                                <div class="basic-form">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input  id="mname" type="text" class="form-control input-flat" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">国家</p>
                                            <input id="country" type="text" class="form-control input-default " placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">导演</p>
                                            <input  id="director" type="text" class="form-control input-flat" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">主演</p>
                                            <input  id="actor" type="text" class="form-control input-flat" placeholder="...">
                                        </div>
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">类型</p>
                                            <input  id="mtype" type="text" class="form-control input-flat" placeholder="...">
                                        </div>
                                        <div>
                                            <<input type="button" onclick="addMovie()" class="btn btn-warning"  value="提交" />
                                        </div>
                                    </form>
