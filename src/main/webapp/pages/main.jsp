            ...
            function getData() {
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        var nice = document.getElementsByName('nice');
                        ...
                        for (let q=0;q<mydata.length;q++){
                            ...
                            nice[q].innerText=mydata[q].nice;
                            pid[q].id=mydata[q].pid;
                            pid[q].onclick = function () {
                                addNice(mydata[q].pid)
                            };
    ...
    <script>
        function addNice(q) {
            ...
            $.ajax({
                ...
                type: "POST",//方法类型
                dataType: "json",//预期服务器返回的数据类型
                url: "${pageContext.request.contextPath}/post/addNice" ,//url
                data: JSON.stringify({
                    pid: q.valueOf(),
                }),
                                    ...
                                    <ul>
                                        ...
                                        <li class="card-option drop-menu"><i class="ti-settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="link"></i>
                                            <ul class="card-option-dropdown dropdown-menu">
                                                <li><a href="index.jsp"><i class="ti-loop"></i> 刷新</a></li>
                            ...
                            <div class="card-body">
                                <table class="table table-responsive table-hover ">
                                    ...
                                    <tr>
                                        ...
                                        <td name="user"></td>
                                        <td name="datetime"></td>
                                        <td name="nice" class="color-warning"></td>
                                        <td name="pid"><span onclick="" class="btn btn-danger">点赞</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td name="datetime"></td>
                                        <td name="nice" class="color-warning"></td>
                                        <td name="pid"><span class="btn btn-danger">点赞</span></td>
                                        <td name="look"><a href="" class="btn btn-warning">浏览</a></td>
                                    </tr>
                                    <tr>
                                        <td name="topic"></td>
                                        <td name="user"></td>
